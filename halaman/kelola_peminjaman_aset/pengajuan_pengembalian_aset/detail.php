...
if (isset($_POST['submit'])) {
    ...
    $status = $_POST['submit'] === 'terima' ? 6 : 5;
    ...
    try {
        ...
        $q = "
            UPDATE 
                peminjaman_aset 
            SET 
                timestamp_pengembalian_ditentukan='" . Date('Y-m-d H:i:s') . "', 
        ...
        $mysqli->query($q);
        if ($status == 6)
            $mysqli->query("UPDATE aset SET status=1 WHERE id=" . $_GET['id']);
                    ...
                    <div class="row">
                        <form action="" method="POST">
                            <div class="col-12">
                                ...
                                <div class="mb-3">
                                    <label class="form-label">Keterangan Penerimaan</label>
                                    <textarea class="form-control p-2" disabled><?= $data['keterangan_pengajuan'] ?></textarea>
                                </div>
                                <hr>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control p-2" disabled><?= $data['alasan_pengembalian']; ?></textarea>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="d-flex justify-content-between flex-wrap">
                                    <div class="d-flex align-items-center flex-grow-1">
                                        <a href="?h=pengajuan_pengembalian_aset_per_kategori_aset&id=<?= $data['id_kategori_aset']; ?>" class="btn btn-secondary">Kembali</a>
                                    </div>
