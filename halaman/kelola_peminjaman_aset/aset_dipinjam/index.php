            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-success shadow-success border-radius-lg p-3 d-flex justify-content-between align-items-center">
                        <h6 class="text-white text-capitalize m-0">Data Aset Dipinjam</h6>
                        ...
                        <table id="datatable" class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-uppercase text-center text-secondary text-xs font-weight-bolder opacity-7">Jumlah Dipinjam</th>
                                </tr>
                            </thead>
                            <?php
                            $q = "
                            SELECT 
                                *,
                                (SELECT COUNT(*) FROM aset WHERE aset.id_kategori_aset=ka.id AND aset.status=5) dipinjam
                            FROM 
                                kategori_aset ka";
                            ...
                            <tbody>
                                <?php while ($row = $result->fetch_assoc()) : ?>
                                    <tr>
                                        ...
                                        <td class="small-td">
                                            <a href="?h=aset_dipinjam_per_kategori_aset&id=<?= $row['id']; ?>" class="btn btn-sm btn-info text-white">Lihat</a>
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
                            </tbody>
