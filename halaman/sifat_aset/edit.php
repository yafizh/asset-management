...
$q = "SELECT * FROM sifat_aset WHERE id=" . $_GET['id'];
...
if (isset($_POST['submit'])) {
    ...
    $q = "UPDATE sifat_aset SET nama='$nama', keterangan='$keterangan' WHERE id=" . $_GET['id'];
    if ($mysqli->query($q)) {
            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-success shadow-success border-radius-lg p-3 d-flex justify-content-between align-items-center">
                        <h6 class="text-white text-capitalize m-0">Edit Sifat Aset</h6>
                    </div>
                </div>
                <div class="card-body">
