            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg p-3 d-flex justify-content-between align-items-center">
                        <h6 class="text-white text-capitalize m-0">Data Sifat Aset</h6>
                        <a href="?h=tambah_sifat_aset" class="btn btn-success m-0">Tambah</a>
                    </div>
                </div>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="small-td">
                                        ...
                                        <a href="?h=delete_sifat_aset&id=" class="btn btn-sm btn-danger">Hapus</a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
