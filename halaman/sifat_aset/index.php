            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-success shadow-success border-radius-lg p-3 d-flex justify-content-between align-items-center">
                        <h6 class="text-white text-capitalize m-0">Data Jenis Aset</h6>
                        <a href="?h=tambah_sifat_aset" class="btn btn-dark m-0">Tambah</a>
                    </div>
                </div>
                            ...
                            <tbody>
                                <?php while ($row = $result->fetch_assoc()) : ?>
                                    <tr>
                                        ...
                                        <td class="small-td">
                                            <a href="?h=edit_sifat_aset&id=<?= $row['id']; ?>" class="btn btn-sm btn-warning text-white">Edit</a>
                                            <a href="?h=hapus_sifat_aset&id=<?= $row['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Yakin?')">Hapus</a>
                                        </td>
                                    </tr>
                                <?php endwhile; ?>
                            </tbody>
